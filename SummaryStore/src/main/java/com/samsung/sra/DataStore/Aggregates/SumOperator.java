...
public class SumOperator implements WindowOperator<Long,Double,Pair<Double,Double>> {
    ...
    static class QueryEstimator {
        ...
        QueryEstimator(long T0, long T1, Stream<SummaryWindow> buckets, Function<SummaryWindow, Long> sumRetriever) {
    ...
    public ResultError<Double, Pair<Double, Double>> query(StreamStatistics streamStats,
                                                           long T0, long T1, Stream<SummaryWindow> summaryWindows, Function<SummaryWindow, Long> sumRetriever,
                                                           long t0, long t1, Object... params) {
        QueryEstimator estimator = new QueryEstimator(T0, T1, summaryWindows, sumRetriever );
