 ...
 */
public class PolynomialWindowLengths implements WindowLengthSequence {
     ...
     */
    public static WindowLengthSequence getWindowingOfSize(double degree, long rangeSize, int numWindows) {
