...
public class SummaryStore implements DataStore {
    ...
    public SummaryStore(String rocksDBPath, BucketMerger merger) throws RocksDBException {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            //store = new SummaryStore(storeLoc, new ExponentialWBMHBucketMerger(3));
            store = new SummaryStore(storeLoc, new LinearBucketMerger(3));
