...
public class AgeLengthEffect {
    ...
    public static void main(String[] args) {
        try {
            ...
            datastores.put("summarystore", new SummaryStore(prefix + "summarystore", new ExponentialWBMHBucketMerger(2)));
            datastores.put("linearstore", new SummaryStore(prefix + "linearstore", new LinearBucketMerger(4546)));
