...
public class QDigest {
	...
	QDigest qW1 = new QDigest(k);
	QDigest qW2 = new QDigest(k);
	...
	QDigest qUnion;
        qUnion = unionOf(qW1, qW2);	

	System.out.println("90th quantile " + qW1.getQuantile(0.9));
	System.out.println("90th quantile " + qW2.getQuantile(0.9));
	System.out.println("90th quantile " + qUnion.getQuantile(0.9));
