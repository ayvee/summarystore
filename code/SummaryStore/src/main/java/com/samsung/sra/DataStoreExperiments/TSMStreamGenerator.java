...
/**
 * If cmsMode: generate stream with 2d value = (nodeID, bytes)
 * If !cmsMode: generate stream with scalar value = bytes
 */
public class TSMStreamGenerator implements StreamGenerator {
    ...
    public TSMStreamGenerator(Toml params) throws IOException {
        this(params.getString("file"), params.getString("separator", ","), params.getBoolean("cms-mode", false));
    }
